...
while IFS= read -r Token; do
    echo "$Token"
    Snippet=$(/Users/petr/Library/Developer/Xcode/DerivedData/code-snippets-extractor-aoufylxbxfppcicbvfbkiuokarqf/Build/Products/Debug/code-snippets-extractor $SourceCodeDir $Token)
